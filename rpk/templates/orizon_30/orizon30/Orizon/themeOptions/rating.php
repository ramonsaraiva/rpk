...
?>
<p>
<label for="my_meta_box_text"><b>Over All Score</b></label>
...
<p>
<label for="creteria_1"><b>Critera 1</b></label>
<input type="text" name="creteria_1_text" id="creteria_1_text" value="<?php echo $creteria_1_text; ?>" />
</p>
<p>
<label for="creteria_1"><b>Critera 1 Score</b></label>
...
<p>
<label for="creteria_2"><b>Critera 2</b></label>
<input type="text" name="creteria_2_text" id="creteria_2_text" value="<?php echo $creteria_2_text; ?>" />
</p>
<p>
<label for="creteria_2"><b>Critera 2 Score</b></label>
...
<p>
<label for="creteria_4_text"><b>Critera 4</b></label>
<input type="text" name="creteria_4_text" id="creteria_4_text" value="<?php echo $creteria_4_text; ?>" />
</p>
<p>
<label for="creteria_4"><b>Critera 4 Score</b></label>
...
<p>
<label for="creteria_5_text"><b>Critera 5</b></label>
<input type="text" name="creteria_5_text" id="creteria_5_text" value="<?php echo $creteria_5_text; ?>" />
</p>
<p>
<label for="creteria_5"><b>Critera 5 Score</b></label>

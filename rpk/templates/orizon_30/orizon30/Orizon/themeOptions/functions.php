...
if ( get_stylesheet_directory() == get_template_directory() ) {
	...
	define('OPTIONS_FRAMEWORK_URL', get_stylesheet_directory() . '/themeOptions/admin/');
	define('OPTIONS_FRAMEWORK_DIRECTORY', get_stylesheet_directory_uri() . '/themeOptions/admin/');
}

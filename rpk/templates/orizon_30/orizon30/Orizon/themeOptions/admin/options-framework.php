...
function optionsframework_init() {
	...
	// Loads the options array from the theme  **This is for the BioSphere theme
	if ( $optionsfile = locate_template( array('themeOptions/options.php') ) ) {
...
function optionsframework_add_page() {
	...
	$of_page = add_theme_page('Theme Options', '', 'edit_theme_options', 'options-framework','optionsframework_page');
...
function optionsframework_load_styles() {
	...
	wp_enqueue_style('engage.itoggle', OPTIONS_FRAMEWORK_DIRECTORY.'css/engage.itoggle.css');	
	wp_enqueue_style('', OPTIONS_FRAMEWORK_DIRECTORY.'widget/latest_twitter_widget.css');	
	$_html = '';
...
function optionsframework_load_scripts() {
	...
	wp_enqueue_script('jquery-ui-core');
		wp_enqueue_script('googlejs', OPTIONS_FRAMEWORK_DIRECTORY.'js/googlejs.js', array('jquery'));
	wp_enqueue_script('color-picker', OPTIONS_FRAMEWORK_DIRECTORY.'js/colorpicker.js', array('jquery'));
	wp_enqueue_script('options-custom', OPTIONS_FRAMEWORK_DIRECTORY.'js/options-custom.js', array('jquery'));
	wp_enqueue_script('engage.itoggle', OPTIONS_FRAMEWORK_DIRECTORY.'js/engage.itoggle.js', array('jquery'));
	wp_enqueue_script('easing', OPTIONS_FRAMEWORK_DIRECTORY.'js/easing.js', array('jquery'));
...
<form action="options.php" method="post">
  <div id="main">
    <div class="nav-tab-wrapper"> <img id="logo-img" src="<?php echo get_template_directory_uri(); ?>/themeOptions/admin/images/logo_panel.jpg"> <?php echo $return[1]; ?> </div>
    <div class="metabox-holder">
      <div id="optionsframework" class="postbox">
        <div id="theme_header">
          ...
          <div class="visit">
            <p style="margin:13px 0 0 15px;">Visit my profile!</p>
            <a class="visit_profile" href="http://themeforest.net/user/Skywarrior" target="_blank"></a> </div>
          <div class="need_help">
            <p>Need help?</p>
            <a class="documentation" href="http://skywarriorthemes.com/orizon/wp/instructions/instructions.html" target="_blank"></a> <a class="forum" href="http://support.skywarriorthemes.com" target="_blank"></a> </div>
  ...
  <div class="save_bar_top">
   <div id="optionsframework-submit">
            <input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save All Changes' ); ?>" />
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults Options' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!' , 'gp') ); ?>' );" />
            <div class="clear"></div>
          </div>
  </div> 
 </form>
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['update'] ) ) {
		...
		foreach ( $options as $option ) {
			...
			if ( 'jqueryselect' == $option['type'] && ! isset( $input[$id] ) ) {
				$input[$id] = '0';
			}

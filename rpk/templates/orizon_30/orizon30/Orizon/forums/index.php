...
<h2> <span><?php bloginfo('name'); ?> //&nbsp;</span><?php _e( 'Forums Directory', 'buddypress' ); ?></h2>
<?php } else { ?>
	...
	<div id="content">
		<div class="padder">
			...
			<div class="item-list-tabs" id="subnav" role="navigation">
				...
				<h3 class="forums-search-form-h3"><?php if ( is_user_logged_in() ) : ?> &nbsp;<a class="button show-hide-new" href="#new-topic" id="new-topic-button"><?php _e( 'New Topic', 'buddypress' ); ?></a><?php endif; ?></h3>
			</form>
